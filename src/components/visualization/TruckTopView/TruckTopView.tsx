 ...
 */
export const TruckTopView = forwardRef<HTMLDivElement, TruckTopViewProps>(
  ({ dataVehicle, dataCargo, dataResultCalc }, ref) => {
    const trailerRef = useRef<HTMLDivElement>(null);
    const trailerWidthPx = useContentWidthWithoutBorder(trailerRef);
    ...
    return (
      <div ref={ref} className={styles.vehicle} data-cargo-plan-root>
        <Tractor
